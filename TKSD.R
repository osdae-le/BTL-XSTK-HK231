...
df <- df[ , c("Name", "Max_Power", "Memory_Bandwidth", "Memory_Speed", "Pixel_Rate", "Texture_Rate", "Release_Date")]
View(df)
...
colnames(dfNums) <- c("Max_Power", "Memory_Bandwidth", "Memory_Speed", "Pixel_Rate", "Texture_Rate", "Release_Date")
head(dfNums) 
